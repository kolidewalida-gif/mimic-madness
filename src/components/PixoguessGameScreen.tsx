              ...
              <HolographicCard className="p-4">
                <div className="mb-4 grid gap-3 md:grid-cols-3">
                  <div className="rounded-xl border border-white/10 bg-white/5 px-3 py-3">
                    ...
                    <div className="mt-1 text-lg font-bold text-primary">{roundAttemptCount}</div>
                    <div className="text-xs text-foreground-muted">tentatives lancees</div>
                  </div>
                  <div className="rounded-xl border border-white/10 bg-white/5 px-3 py-3">
                    <div className="text-[11px] uppercase tracking-[0.24em] text-foreground-muted">Lecture</div>
                    <div className="mt-1 text-lg font-bold text-primary">{solvedPlayersCount}</div>
                    <div className="text-xs text-foreground-muted">joueur{solvedPlayersCount > 1 ? 's' : ''} ont lock</div>
                  </div>
                  <div className="rounded-xl border border-white/10 bg-white/5 px-3 py-3">
                    <div className="text-[11px] uppercase tracking-[0.24em] text-foreground-muted">Hint live</div>
                    <div className="mt-1 text-sm font-semibold text-foreground">
                      {roundHint ?? 'Aucun indice pour le moment'}
                    </div>
                  </div>
                </div>
