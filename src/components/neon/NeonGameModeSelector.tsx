...
export const NEON_MODES: ModeMeta[] = [
  {
    ...
    accent: 'from-emerald-400 to-[var(--ink-surface-3)]',
    minPlayers: 2,
    duration: '~10 min',
  },
  {
    ...
    accent: 'from-[var(--ink-surface-2)] to-blue-500',
    minPlayers: 2,
    duration: '~8 min',
  },
  {
    ...
    accent: 'from-[var(--ink-accent)] to-rose-500',
    minPlayers: 2,
    duration: '~6 min',
  },
  {
    ...
    accent: 'from-[var(--ink-accent)] to-[var(--ink-accent-strong)]',
    minPlayers: 3,
    duration: '~12 min',
  },
  {
  ...
  },
  {
    ...
    accent: 'from-[var(--ink-surface-2)] to-teal-400',
    minPlayers: 2,
    duration: '~15 min',
  },
  {
