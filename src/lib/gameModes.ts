...
export const GAME_MODE_META: Record<LobbyGameMode, GameModeMeta> = {
  normal: {
    ...
    minPlayers: 2, accent: '#a78bfa', fallbackColor: '#7c3aed', fallbackEmoji: '🎤',
  ...
  audiophone: {
    ...
    minPlayers: 2, accent: '#22d3ee', fallbackColor: '#0e7490', fallbackEmoji: '🔊',
  ...
  '2v2': {
    ...
    minPlayers: 4, accent: '#60a5fa', fallbackColor: '#2563eb', fallbackEmoji: '⚔️',
  ...
  quiz: {
    ...
    minPlayers: 2, accent: '#a3e635', fallbackColor: '#4d7c0f', fallbackEmoji: '❓',
  ...
  pixoguess: {
    ...
    minPlayers: 2, accent: '#22d3ee', fallbackColor: '#0891b2', fallbackEmoji: '🖼️',
  ...
  monopoly: {
    ...
    minPlayers: 2, accent: '#34d399', fallbackColor: '#047857', fallbackEmoji: '🏠',
  ...
  undercover: {
    ...
    minPlayers: 3, accent: '#c084fc', fallbackColor: '#7e22ce', fallbackEmoji: '🕵️',
  ...
  memorise: {
    ...
    minPlayers: 2, accent: '#e879f9', fallbackColor: '#a21caf', fallbackEmoji: '🎵',
  ...
  mimic: {
    ...
    minPlayers: 2, accent: '#ff4fa3', fallbackColor: '#be185d', fallbackEmoji: '🎤',
